---
title: "Pointer[195]: Non si nomina l’elefante rosa"
description: "🐘 Perchè non dovreste nominare l'elefante rosa? È stato recentemente pubblicato un paper che propone un metodo innovativo per il training di LLM che permette di cambiarne e personalizzarne il comportamento ad inference time. Questo è anche l'argomento che dà il titolo dell'episodio. Riusciranno le LLM a non nominare l'elefante rosa? 📣 Se avete una idea innovativa riguardo al modo in cui potrebbero essere utilizzati i computer quantistici, Google sta cercando proprio voi! L'azienda ha messo in palio ben 5 milioni di dollari in un contest destinato a ricercare applicazioni utili per i computer quantistici. 💶 Torniamo a parlare anche di emulatori della Nintendo Switch., purtroppo questa volta con una cattiva notizia. Nintendo ha infatti denunciato Yuzu, uno degli emulatori più conosciuti che è ora costretto a pagare una multa salata. Stessa sorte è toccata ad Apple con la multa ricevuta dall'Unione Europea."
date: 2024-03-08
categories:
    - Podcast
episode: 195
...
- [La vicenda Yuzu vs Nintendo](https://twitter.com/oatmealdome/status/1764704580724576465)
- [Why I Think Apple’s Fine is Fine](https://havn.blog/2024/03/04/why-i-think.html)
...
- [Il MacPad](https://www.macstories.net/stories/macpad-how-i-created-the-hybrid-mac-ipad-laptop-and-tablet-that-apple-wont-make/)
